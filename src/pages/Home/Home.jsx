            ...
            <div className="home__gradient">
                <div className="home__greeting">
                    ...
                    <div className="home__greeting-headline">
                        <div><img src={Logo} width={500} height={400} alt="No img found"></img></div>
                        <div className="home__greeting-headline--text">
                            ...
                            <h3>Международная площадка для ведения переговоров, новое интеграционное объединение,
                                объединяющее функции, возможности, привилегии международных организаций на евразийском пространстве.</h3>
                        </div>
                    </div>
                    ...
                    <AnimationOnScroll animateIn="animate__fadeInLeft">
                        <div className="home__main">
                          <div>
                            ...
                            <h2 className="home__main-goal">Цель Континентального Союза – объединение дружественных стран для построения крепкой культурной и экономической базы 
                          ...
                          <div>
                            <img src={Handshake} width={500} height={400} alt="Img not found" />
                          </div>
                        </div>
                    </AnimationOnScroll>
                </div>
